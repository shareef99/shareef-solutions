...
function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" lastUpdated="16 May 2026">
      <section>
        <p>
          Shareef Solutions (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot;
          or &quot;our&quot;), located at Talab Katta, Bhavani Nagar, Hyderabad,
          Telangana, India, is committed to protecting the privacy of our
          clients and website visitors. This Privacy Policy describes how we
          collect, use, disclose, and safeguard your information in compliance
      ...
      <section>
        ...
        <ul>
          <li>Fill out a contact form or send us an inquiry</li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>To communicate with you regarding projects, inquiries, and support</li>
          <li>To process payments and send invoices</li>
          <li>To comply with legal obligations and enforce our agreements</li>
          <li>To send updates about our services (only with your consent)</li>
      ...
      <section>
        ...
        <ul>
          <li>
            ...
            providers who assist in delivering our services (e.g., payment
            processors, cloud hosting providers), bound by confidentiality
            agreements.
          </li>
          <li>
            <strong>Legal Requirements:</strong> When required by law, court
            order, or governmental regulation, or to protect our rights, privacy,
            safety, or property.
          </li>
          <li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Secure storage of sensitive information with access controls</li>
      ...
      <section>
        <h2>6. Your Rights</h2>
        <p>
          Under applicable Indian law, you have the following rights regarding
          your personal data:
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Withdrawal of Consent:</strong> You may withdraw consent for
            processing of your personal data at any time.
          </li>
          <li>
            <strong>Grievance Redressal:</strong> You may file a complaint with
            our Grievance Officer if you believe your data has been mishandled.
          </li>
        </ul>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          obligations, resolve disputes, and enforce our agreements. Once the
          retention period expires, data is securely deleted or anonymized.
        </p>
      </section>
